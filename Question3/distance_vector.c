...
/* Moved struct event definition here */
struct event {
...
void init(void); /* Added prototype for init */
void rtinit0(void);
void rtinit1(void);
void rtinit2(void);
void rtinit3(void);
...
float jimsrand() 
{
  double mmm = RAND_MAX;   /* Use RAND_MAX instead of hardcoded value */
